...
const createDealsCollection = async (req) => {
  try {
    ...
    const agentObjectId = new ObjectId(agentId); // vikram add
    ...
    const agent = await agentModel.findById(agentObjectId);
    ...
    if (isPayment) {
      ...
      dealCollection = await dealsCollectionModel.create({
        ...
        agentId: agentObjectId, // vikram add
        paymentMode,
    ...
    return {
      ...
      data: {
        ...
        dealAgentNameId: deal.agentNameId,
        agentId, // vikram
        agentName: agent.agentIdNo, // vikram
        walletAmount,
        interestApplied,
    ...
    const aggregatePipeline = [
      ...
      { $limit: limit },
      {
        $project: {
          ...
          dealCreateAgentNameId: "$dealInfo.agentNameId", // vikram
          agentName: "$agentInfo.agentIdNo", // vikram
